...
{
       0,     0,     3,    11,    14,    15,    20,    25,    27,    34,
      36,    41,    43,    47,    50,    51,    54,    57,    60,    63,
      66,    69,    73,    77,    83,    91,    97,   100,   103,   105,
     109,   111,   113,   117,   121,   125,   129,   133,   135,   137,
     140,   144,   148,   152,   154,   156,   158,   160,   162
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      42,     0,    -1,     5,     3,    35,    43,     6,    48,     7,
      -1,    43,    44,    -1,    -1,    47,    36,    45,    35,    -1,
      47,     1,    45,    35,    -1,     8,    -1,     9,    38,     4,
      39,    10,     8,    -1,     3,    -1,     3,    38,    56,    39,
      -1,    46,    -1,    47,    37,    46,    -1,    48,    49,    -1,
      -1,    50,    35,    -1,    51,    35,    -1,    52,    35,    -1,
      53,    35,    -1,    54,    35,    -1,    50,     1,    -1,    46,
      40,    56,    -1,    46,     1,    56,    -1,    11,    57,    12,
      48,    13,    -1,    11,    57,    12,    48,    14,    48,    13,
      -1,    15,    57,    16,    48,    17,    -1,    18,    47,    -1,
      19,    55,    -1,    56,    -1,    55,    37,    56,    -1,     4,
      -1,    46,    -1,    38,    56,    39,    -1,    56,    25,    56,
      -1,    56,    26,    56,    -1,    56,    27,    56,    -1,    56,
      28,    56,    -1,    23,    -1,    24,    -1,    22,    57,    -1,
      57,    20,    57,    -1,    57,    21,    57,    -1,    56,    58,
      56,    -1,    31,    -1,    32,    -1,    33,    -1,    34,    -1,
      29,    -1,    30,    -1
};
...
{
       0,    43,    43,    57,    60,    64,    66,    75,    77,    84,
      86,    91,    93,   100,   103,   108,   110,   112,   114,   116,
     118,   129,   131,   142,   144,   149,   154,   159,   164,   166,
     173,   175,   177,   179,   181,   183,   185,   192,   194,   196,
     198,   200,   202,   207,   208,   209,   210,   211,   212
};
#endif
...
{
  "$end", "error", "$undefined", "IDENT", "NUMBER", "PROGRAM",
  "BEGIN_PROGRAM", "END_PROGRAM", "INTEGER", "ARRAY", "OF", "IF", "THEN",
  "ENDIF", "ELSE", "WHILE", "LOOP", "ENDLOOP", "READ", "WRITE", "AND",
  "OR", "NOT", "TRUE", "FALSE", "ADD", "SUB", "MULT", "DIV", "EQ", "NEQ",
  "LT", "GT", "LTE", "GTE", "SEMICOLON", "COLON", "COMMA", "L_PAREN",
  "R_PAREN", "ASSIGN", "$accept", "program", "declarations", "declaration",
  "type", "variable", "identifiers", "statements", "statement",
  "statement_assign", "statement_if", "statement_while", "statement_read",
  "statement_write", "expression_list", "expression", "bool_exp", "comp", 0
};
#endif
...
/* Line 1455 of yacc.c  */
#line 174 "TINY_l.y"
    { production[pCount++] = "expression -> NUMBER"; (yyval.intval) = (yyvsp[(1) - (1)].intval); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 178 "TINY_l.y"
    { production[pCount++] = "expression -> ( expression )"; (yyval.intval) = (yyvsp[(2) - (3)].intval); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 180 "TINY_l.y"
    { production[pCount++] = "expression -> expression + expression"; (yyval.intval) = (yyvsp[(1) - (3)].intval) + (yyvsp[(3) - (3)].intval); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 197 "TINY_l.y"
    { production[pCount++] = "bool_exp -> NOT bool_exp"; (yyval.intval) = !(yyvsp[(2) - (2)].intval); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 199 "TINY_l.y"
    { production[pCount++] = "bool_exp -> bool_exp AND bool_exp"; (yyval.intval) = (yyvsp[(1) - (3)].intval) && (yyvsp[(3) - (3)].intval); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 201 "TINY_l.y"
    { production[pCount++] = "bool_exp -> bool_exp OR bool_exp"; (yyval.intval) = (yyvsp[(1) - (3)].intval) || (yyvsp[(3) - (3)].intval); ;}
    break;
